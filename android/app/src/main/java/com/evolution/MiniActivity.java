...
import com.evolution.control.InitConfig;
import com.evolution.listener.MessageListener;
import com.evolution.util.AutoCheck;
...
public class MiniActivity extends AppCompatActivity {
     ...
     * 本demo的包名是com.evolution，定义在build.gradle中。
     */
...
//        });
        ...
        // 6. 初始化
        vit = mSpeechSynthesizer.initTts(ttsMode);
    ...
    private boolean checkAuth() {
        ...
        if (!authInfo.isSuccess()) {
            // 离线授权需要网站上的应用填写包名。本demo的包名是com.evolution，定义在build.gradle中
...
//                print("[ERROR] 初始化失败！！！");
    ...
    public  void speak(Callback errorCallback,
...
//            print("[ERROR], 初始化失败");
        ...
        try {
            ...
            successCallback.invoke(result+"--"+vit);
